...
const GrayWhisperPost: React.FC = () => {
    ...
    <div>
      ...
      {contentObject &&
        contentObject.content.map((content, index: number) => (
          <section
            key={index}
            className="relative text-black shadow-lg p-10 px-12 overflow-hidden printSection"
            style={{
          ...
          >
            <h1 className="text-3xl font-semibold z-10 text-black-200">
            ...
            <div className="absolute bottom-2 left-3 flex items-center gap-3 text-black/60">
              {profilePic && (
                <Image
...
export default GrayWhisperPost;
