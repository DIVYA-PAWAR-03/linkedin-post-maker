  ...
  return (
    ...
    >
      <div className="text-center flex flex-col justify-center mt-20 items-center gap-2">
        <h6 className="mb-1 text-2xl text-white/80">Follow</h6>
        {profilePic && (
          <Image
        ...
        <h6 className="-mt-1 text-white/80 text-2xl">
          for more content like this
        </h6>
      </div>
      <div className="absolute bottom-5 left-6 flex flex-col gap-2 text-white/80">
